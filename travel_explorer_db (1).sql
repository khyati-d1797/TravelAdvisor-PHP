...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2022 at 05:44 AM
...
INSERT INTO `sites` (`id`, `site_name`, `site_description`, `site_rating`, `site_price`, `des_id`) VALUES
...
(26, 'The montreal museum of fine arts', 'The Montreal Museum of Fine Arts is an art museum in Montreal, Quebec, Canada. It is the largest art museum in Canada by gallery space. The museum is located on the historic Golden Square Mile stretch of Sherbrooke Street. The MMFA is spread across five pavilions, and occupies a total floor area of 53,095 square metres, 13,000 of which are exhibition space. With the 2016 inauguration of the Michal and Renata Hornstein Pavilion for Peace, the museum campus was expected to become the eighteenth largest art museum in North America. The permanent collection included approximately 44,000 works in 2013. The original reading room of the Art Association of Montreal was the precursor of the museum\'s current library, the oldest art library in Canada. The Montreal Museum of Fine Arts is a member of the International Group of Organizers of Large-scale Exhibitions, also known as the Bizot Group, a forum which allows the leaders of the largest museums in the world to exchange works and exhibitions. ', '0.9', 24, 5),
(27, 'Mount Royal', 'Mount Royal is a large intrusive rock hill or small mountain in the city of Montreal, immediately west of Downtown Montreal, Quebec, Canada. The best-known hypothesis for the origin of the name Montreal is that the name is taken from Mount Royal. The hill is part of the Monteregian Hills situated between the Laurentians and the Appalachian Mountains. It gave its Latin name, Mons Regius, to the Monteregian chain. The hill consists of three peaks: Colline de la Croix at 233 m, Colline d\'Outremont at 211 m, and Westmount Summit at 201 m elevation above mean sea level.', '0.9', 0, 5),
(28, 'La Ronde', 'La Ronde is an amusement park in Montreal, Quebec, Canada, built as the entertainment complex for Expo 67, the 1967 World Fair. Today, it is operated by Six Flags under an emphyteutic lease with the City of Montreal, which expires in 2065. It is the largest amusement park in Quebec and second largest in Canada. It is on 59 hectares located on the Northern tip of Saint Helen\'s Island. This is a man-made extension to the island in the space where the small Ronde Island had been. The park hosts L\'International des Feux Loto-Québec, an international fireworks competition. La Ronde is one of three Six Flags parks not to be officially branded as a Six Flags park, Great Escape in Queensbury, New York, and Frontier City in Oklahoma City, Oklahoma being the other two.', '0.9', 42, 5),
(29, 'Montreal Underground City', 'RÉSO, commonly referred to as the Underground City, is the name applied to a series of interconnected office towers, hotels, shopping centres, residential and commercial complexes, convention halls, universities and performing arts venues that form the heart of Montreal\'s central business district, colloquially referred to as Downtown Montreal. The name refers to the underground connections between the buildings that compose the network, in addition to the network\'s complete integration with the city\'s entirely underground rapid transit system, the Montreal Metro. Moreover, the first iteration of the Underground City was developed out of the open pit at the southern entrance to the Mount Royal Tunnel, where Place Ville Marie and Central Station stand today. Though most of the connecting tunnels pass underground, many of the key passageways and principal access points are located at ground level, and there is also one skybridge. In this regard, the Underground City is more of an indoor ', '0.9', 0, 5),
(30, 'Montreal Science Centre', 'The Montreal Science Centre is a science museum in Montreal, Quebec, Canada. It is located on the King Edward Pier in the Old Port of Montreal. Established in 2000 and originally known as the iSci Centre, the museum changed its name to the Montreal Science Centre in 2002. The museum is managed by the Old Port of Montreal Corporation. The museum is home to interactive exhibitions on science and technology as well as an IMAX theatre.', '0.9', 35, 5);
